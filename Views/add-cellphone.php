...
<main class="container clear"> 
    <div class="content"> 
      <div id="comments" >
        ...
        <form action=<?php echo FRONT_ROOT ?>Cellphone/AddIDUnico method="post"  style="background-color: #EAEDED;padding: 2rem !important;">
          <table> 
            <thead>
              <tr>
                <th>Code</th>
          ...
          <div>
            ...
            <input onclick="location.href= 'ShowListView'"  type="submit" class="btn" value="LIST" style="background-color:#DC8E47;color:white;"/>
          </div>
        </form>
      </div>
        <?php 

...
<main class="mx-auto h-75">
     <section id="listado" class="mb-5">
          <div class="container">
               <h2 class="mb-4">Nuevo Usuario Empresa </h2>
                    ...
                    <div class="row justify-content-start">
                         ...
                         <form action=<?php echo FRONT_ROOT ?>NewUser/AddUser method="POST">
                              ...
                              <div class="row justify-content-start">
                                        ...
                                        <label for="">Posición Laboral:</label>
                                             <div class="form-group">
                                                  <select name="companyId" class="form-control">
                                                       <option selected="true" disabled="disabled">Seleccione Una Empresa</option>
                                   ...
                                   <!-- <input type="hidden" name="profile" value="company"></input> -->
                                   ...
                                   <a type="button" class="btn btn-success" href="<?php echo FRONT_ROOT . 'NewUser/ShowAdminAddView' ?>">Nuevo Administrador</a>
                                   <button type="submit" name="profile" value ="Company" class="btn btn-primary ml-auto d-block">Agregar Usuario Empresa </button>
